...
function Model(options = {}) {
    return (target) => {
        ...
        MongooseModels_1.MongooseModels.set(name, target);
        ...
        MongooseModelRegistry_1.registerModel({
            ...
            useFactory(connections) {
                ...
                return utils_1.createModel(target, schema, options.name, options.collection, options.skipInit, connections.get(options.connection));
            }
        });
    };
}
